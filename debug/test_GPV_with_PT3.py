...
if __name__ == "__main__":
    model = test_PT3()
    dataset_train, dataset_test_intra, dataset_test_inter = get_datasets(root_dir, test_intra_dir, test_inter_dir, voxelization=True, shot=False)
    ...
    train(model, dataloader_train, dataloader_test_inter, dataloader_test_intra, 0.001, 40, "./log_dir/PointTransformer_test_sym_v1")