...
if __name__ == "__main__":
    ...
    model = test_GPV()
    train(model, dataloader_train, dataloader_test_inter, dataloader_test_intra, 0.005, 40, "./log_dir/GPV_test_sym_v1")
    torch.save(model.state_dict(), "/home/zhangran/desktop/tmp/backup_sym_lr=0.005.pth")