...
def get_args():
    ...
    parser.add_argument("--root_dir", type=str, default="/data/zhangran/GAPartNet_re_rendered/train")
    parser.add_argument("--test_intra_dir", type=str, default="/data/zhangran/GAPartNet_re_rendered/test_intra")
    parser.add_argument("--test_inter_dir", type=str, default="/data/zhangran/GAPartNet_re_rendered/test_inter")
