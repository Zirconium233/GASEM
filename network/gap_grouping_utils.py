...
def _compute_ap_per_class(
    ...
    if tp.shape[0] == 0 or num_gt_instances == 0:
        return float('nan')  # Motified, Return NaN if no ground truth instances exist for this class, and no predictions are made
